-- 20260530000001_create_tables.sql
-- Creates job_listings and employer_company_details tables from scratch

-- Create employer_company_details table
...
-- Indexes for job_listings
CREATE INDEX IF NOT EXISTS idx_job_listings_trade ON public.job_listings(trade);
...
CREATE INDEX IF NOT EXISTS idx_job_listings_is_urgent ON public.job_listings(is_urgent) WHERE is_urgent = TRUE;
CREATE INDEX IF NOT EXISTS idx_job_listings_employer ON public.job_listings(employer_id);