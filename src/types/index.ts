...
import { Profile } from '@/types'; // Tog bort CandidateProfile härifrån för att undvika typ-krockar
...
function EmployerDirectoryContent() {
  ...
  // Candidates & Search States (explicitly typed as any[] to prevent TypeScript build errors)
          ...
          <main className="candidates-area">
            ...
            {isFetchingCandidates ? (
              ...
              <div className="space-y-4">
                {/* Här sätter vi candidate: any för att tysta TypeScript helt */}
                {candidates.map((candidate: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Display Certificates (Visible to everyone) */}
